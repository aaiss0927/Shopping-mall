...
<section>
    <div style="width:60%; margin:auto;">
        <strong style="font-size:25px">문의하기</strong><hr style="background:skyblue; height:2.5px; border:0;"><br>
        <table>
            <thead>
            <tr>
                <th>번호</th><th>제목</th><th>작성자</th><th>작성일</th><th>조회수</th><th>삭제</th>
            </tr>
            </thead>
            <tbody>
            <c:forEach items="${boardList}" var="board">
                <tr>
                    ...
                    <td><a href="/admin/board/delete?id=${board.id}" style="text-decoration: none">삭제</a></td>
                </tr>
            </c:forEach>
            </tbody>
        </table><br>
        ...
        <div align="center">
            <c:choose>
                ...
                <c:otherwise>
                    <a href="/admin/board/paging?page=${paging.page-1}" style="text-decoration: none">[이전]</a>
                </c:otherwise>
            </c:choose>
            ...
            <c:forEach begin="${paging.startPage}" end="${paging.endPage}" var="i" step="1">
                <c:choose>
                    ...
                    <c:otherwise>
                        <input type="button" value="${i}" onclick="location.href='/admin/board/paging?page=${i}'">
                    </c:otherwise>
                </c:choose>
            </c:forEach>
            ...
            <c:choose>
                ...
                <c:otherwise>
                    <a href="/admin/board/paging?page=${paging.page+1}" style="text-decoration: none">[다음]</a>
                </c:otherwise>
            </c:choose>
        </div>
    </div>
