    ...
    <nav>
		...
		<section>
			<div style="width:60%; margin:auto;">
				<strong style="font-size:25px">로그인</strong><hr style="background:skyblue; height:2.5px; border:0;">
				<form style="margin:auto" action="/member/login" method="post">
                    <div style="display: inline-block">
                    	<table border="0" style="margin-left: 50px; margin-top: 130px">
                        <tr>
                            <td style="height:20px; width:80px"><strong>아이디</strong><td>
                            <td>
                    ...
                    <span style="margin-left: 50px; font-size: 12px">
                        <a href="" style="text-decoration: none">아이디찾기</a>&nbsp;&nbsp;
                        <a href="" style="text-decoration: none">비밀번호찾기</a>&nbsp;&nbsp;
                        <a href="/member/signup" style="text-decoration: none">회원가입</a>
                    </span>
                    </div>
                    <div style="float:right; margin-right: 70px; margin-top: 30px;">
                    	<img src="../resources/media/valyrian.jpg" alt="사진 오류" width="500px" height="300px" style="margin-left:110px">
                    </div>
                </form>
			</div>
		</section>
