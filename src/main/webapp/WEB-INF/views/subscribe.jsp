    ...
    <nav>
		...
		<section>
			<div class="container" style="margin-left: 200px; margin-right: 200px">
                ...
                <div class="item"><a href="/product?productSku=${product.productSku}"><img src="${product.productSrc}" width="400px" style="border: 0.5px solid lightgray" height="700px"></a><div style="font-size: 15px"><a href="/product?productSku=${product.productSku}"><br><strong style="color:cornflowerblue">DUNE</strong> ${product.productName}<br><span style="color:gray">&#8361;${product.productPrice}</span></a></div></div>
                </c:forEach>
			</div>
		</section><br><br><br>
