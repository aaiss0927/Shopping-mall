	...
	<nav>
		...
		<section>
			<div style="width:60%; margin:auto;">
			    <strong style="font-size:25px">공지사항</strong><hr style="background:skyblue; height:2.5px; border:0;"><br>
			      <table>
			        <thead>
			          <tr>
			        ...
			        <tbody>
			          <tr>
			            <td>게시물 제목 1</td><td>작성자1</td><td>작성일자1</td><td>0</td>
			          </tr>
			          <tr>
			            <td>게시물 제목 2</td><td>작성자2</td><td>작성일자2</td><td>0</td>
			          </tr>
			          <tr>
			            <td>게시물 제목 3</td><td>작성자3</td><td>작성일자3</td><td>0</td>
			          </tr>
			          <tr>
			            <td>게시물 제목 4</td><td>작성자4</td><td>작성일자4</td><td>0</td>
			          </tr>
			          <tr>
			            <td>게시물 제목 5</td><td>작성자5</td><td>작성일자5</td><td>0</td>
			          </tr>
			          <tr>
			            <td>게시물 제목 6</td><td>작성자6</td><td>작성일자6</td><td>0</td>
			          </tr>
			          <tr>
			            <td>게시물 제목 7</td><td>작성자7</td><td>작성일자7</td><td>0</td>
			          </tr>
			          <tr>
			            <td>게시물 제목 8</td><td>작성자8</td><td>작성일자8</td><td>0</td>
			          </tr>
			          <tr>
			            <td>게시물 제목 9</td><td>작성자9</td><td>작성일자9</td><td>0</td>
			          </tr>
			          <tr>
			            <td>게시물 제목 10</td><td>작성자10</td><td>작성일자10</td><td>0</td>
			          </tr>
			        </tbody>
			      </table><br><br><br>
			      <div align="center">
					  <input type="button" value=" 1 " onclick="location.href=''">
					  <input type="button" value=" 2 " onclick="location.href=''">
				  </div>
			</div>
		</section>
