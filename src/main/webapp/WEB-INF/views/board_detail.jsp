...
<section>
    <div class="container">
        <div class="title" style="margin-bottom: 20px">
            ...
            <span class="date">작성일: ${board.boardCreatedTime}</span>
        </div>
        <div class="content" style="border-top: 1px solid gray">
            <p style="font-weight: bold">제목: ${board.boardTitle}</p><hr>
            <p style="border: 0.5px solid lightgray">${board.boardContents}</p>
        </div>
        <div class="button-group">
            <c:if test="${showButtons}">
                <a class="modify-button" href="/board/delete?id=${board.id}">삭제</a>
                <a class="modify-button" href="/board/update?id=${board.id}">수정</a>
            </c:if>
...
<footer id="footer_1" style="font-size:15px">
    <div style="width:30%; height:80%; margin-left:80px;">
        ...
        <p>&nbsp;&nbsp;이메일을 입력하세요.</p>
        <div class="textbox-container" style="border: 1px solid black">
