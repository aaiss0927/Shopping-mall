...
<section>
    <div style="width:60%; margin:auto;">
        ...
        <table>
            ...
            <tr>
                <td>${board.id}</td>
                <td><a href="/board?id=${board.id}&page=${paging.page}" style="text-decoration: none; color:black;">${board.boardTitle}</a></td>
        ...
        <div></div>
        <input type="button" style="padding:4px 6px; font-size:12px; background: cornflowerblue; color:white; border: none;" value="글쓰기" onclick="location.href='/board/write'"><br><br><br><br><br>
        <div align="center">
            <c:choose>
                ...
                <c:otherwise>
                    <a href="/board/paging?page=${paging.page-1}" style="text-decoration: none">[이전]</a>
                </c:otherwise>
            </c:choose>
            ...
            <c:forEach begin="${paging.startPage}" end="${paging.endPage}" var="i" step="1">
                <c:choose>
                    ...
                    <c:otherwise>
                        <input type="button" value="${i}" onclick="location.href='/board/paging?page=${i}'">
                    </c:otherwise>
                </c:choose>
            </c:forEach>
            ...
            <c:choose>
                ...
                <c:otherwise>
                    <a href="/board/paging?page=${paging.page+1}" style="text-decoration: none">[다음]</a>
                </c:otherwise>
            </c:choose>
        </div>
    </div>
