	...
	<nav>
		...
		<section>
			<div style="width:60%; margin:auto;"]>
				<strong style="font-size:25px">회원가입</strong><hr style="background:skyblue; height:2.5px; border:0;">
				<form action="/member/signup" method="post">
					<fieldset style="width:100%; border:none">
					&nbsp;&nbsp;<strong style="font-size:20px; line-height:30px">필수 정보입력</strong><br>
					<table>
	                    <tr>
	                    ...
	                    <tr>
	                        ...
	                        <td>
	                            <input type="password" name="memberPassword" placeholder="비밀번호 입력" required>
	                            &nbsp;&nbsp;영문, 숫자, 특수문자를 조합하여 8~12자까지 설정해 주세요.
	                        </td>
	                    </tr>
	                    <tr>
	                        <th style="border-bottom: 0.5px solid lightgray">&nbsp;&nbsp;<span style="color:red">*</span>&nbsp;&nbsp;비밀번호 확인</th>
	                        <td style="border-bottom: 0.5px solid lightgray">
	                            <input type="password" name="memberPassword_" placeholder="비밀번호 확인" required>
	                            &nbsp;&nbsp;비밀번호 재입력
	                        </td>
	                    </tr>
                	</table><br>
                	...
                	&nbsp;&nbsp;<strong style="font-size:20px; line-height:30px">기본 정보입력</strong><br>
					<table>
	                    <tr>
	                    ...
	                    <tr>
	                        ...
	                        <td>
                                    <input type="radio" name="memberSex" value="남자" checked>
                                    &nbsp;남
                                    <input type="radio" name="memberSex" value="여자">
                                    &nbsp;여
	                        </td>
	                    </tr>
	                    <tr>
	                    ...
	                    <tr>
	                        ...
	                        <td>
	                            <input type="text" name="memberTel" placeholder="휴대폰 번호 입력" required>
	                            &nbsp;&nbsp;-포함 13자리를 입력하세요.
	                        </td>
	                    </tr>
	                    <tr>
	                        <th style="height: 120px; width: 220px; border-bottom: 0.5px solid lightgray" >&nbsp;&nbsp;<span style="color:red">*</span>&nbsp;&nbsp;주소</th>
	                        <td style="border-bottom: 0.5px solid lightgray">
	                            <div style="margin-top: 5px; margin-bottom: 7px">
	                            	<input type="text" name="memberZip" placeholder="우편번호 입력" readonly>
	                            </div>
	                            <div style="margin-top: 5px; margin-bottom: 7px">
	                            	<input type="text" name="memberAddr1" size="50" placeholder="주소 검색" readonly>
	                            </div>
	                            <div style="margin-top: 5px; margin-bottom: 7px">
	                            	<input type="text" name="memberAddr2" size="50" placeholder="상세주소 입력">
	                            </div>
	                        </td>
	                    </tr>
                	</table><br><br>
