    ...
    <div class="container">
        <form action="/board/update" method="post">
            <div class="form-group">
                ...
                <input type="hidden" name="boardWriter" value="${loginId}" readonly>
            </div>
            ...
            <div class="form-group">
                <label for="boardContents">본문:</label>
                <textarea id="boardContents" name="boardContents" cols="30" rows="15" placeholder="내용을 입력하세요" required>${board.boardContents}</textarea>
            </div>
