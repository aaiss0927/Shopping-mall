...
<html>
            ...
            function init() {
                ...
                for (let i = 0; i < subArray.length; i++) {
                    ...
                    sub.onclick = function() {
                        location.href = "/product/subscribe";
                    };
                }
    ...
    <body onload="init()">
        ...
        <section id="section_1"><strong style="font-size:50px; color: darkslategray;">전자담배 액상<br> 구독 서비스 개시</strong>
        <p class="subscribe"><strong>구독하기</strong></p>
        </section>
        <section id="section_2"><img src="../resources/media/main.jpg" style="width: 100%; height: 100%;"></section>
        <section id="section_3"><strong style="font-size:50px; color: darkslategray;">구독 방법</strong><br><br><br><br><img src="../resources/media/sub_manner.jpg"></section>
        <section id="section_4"><strong style="font-size:50px; color: darkslategray;">구독 서비스 종류</strong><br><br><img src="../resources/media/sub_service.jpg"><p class="subscribe" id="second-subscribe"><strong>구독하기</strong></p>
        </section>
