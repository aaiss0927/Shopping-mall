...
<section>
    <div style="width:60%; margin:auto;">
        ...
        <table>
            <thead>
            <tr>
                <th>번호</th><th>이름</th><th>카테고리</th><th>가격</th><th>재고</th><th>삭제</th>
            </tr>
            </thead>
            <tbody>
            <c:forEach items="${productList}" var="product">
                <tr>
                    ...
                    <td><a href="/product/delete?productSku=${product.productSku}" style="text-decoration: none">삭제</a></td>
                </tr>
            </c:forEach>
            </tbody>
        </table><br>
        ...
        <div align="center">
            <c:choose>
                ...
                <c:otherwise>
                    <a href="/admin/product/paging?page=${paging.page-1}" style="text-decoration: none">[이전]</a>
                </c:otherwise>
            </c:choose>
            ...
            <c:forEach begin="${paging.startPage}" end="${paging.endPage}" var="i" step="1">
                <c:choose>
                    ...
                    <c:otherwise>
                        <input type="button" value="${i}" onclick="location.href='/admin/product/paging?page=${i}'">
                    </c:otherwise>
                </c:choose>
            </c:forEach>
            ...
            <c:choose>
                ...
                <c:otherwise>
                    <a href="/admin/product/paging?page=${paging.page+1}" style="text-decoration: none">[다음]</a>
                </c:otherwise>
            </c:choose>
        </div>
    </div>
