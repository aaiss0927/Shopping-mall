    ...
    <nav>
		...
		<section>
			...
			<div class="container" style="margin-left: 450px; margin-right: 450px">
                ...
                <div class="item"><a href="/product?productSku=${product.productSku}"><img src="${product.productSrc}" width="200px" style="border: 0.5px solid lightgray" height="200px"></a><div style="font-size: 15px"><a href="/product?productSku=${product.productSku}"><br>${product.productName}<br><span style="color:gray">&#8361;${product.productPrice}</span></a></div></div>
                </c:forEach>
			</div><br><br><br>
			<div align="center">
